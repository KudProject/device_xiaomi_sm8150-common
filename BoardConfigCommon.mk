...
ifeq ($(TARGET_IS_VIRTUAL_AB),true)
TARGET_RECOVERY_FSTAB := $(COMMON_PATH)/rootdir/etc/fstab_virtual_ab.qcom
...
ifeq ($(TARGET_IS_VIRTUAL_AB),true)
SOONG_CONFIG_XIAOMI_MSMNILE_ROOTDIR_PARTITION_SCHEME := virtual_ab
else ifneq ($(TARGET_IS_LEGACY),true)
