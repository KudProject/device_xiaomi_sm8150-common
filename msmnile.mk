...
# Consumer IR
ifneq ($(filter consumerir,$(TARGET_HAS_ADDITIONAL_HARDWARE)),)
PRODUCT_PACKAGES += \
...
endif # TARGET_HAS_ADDITIONAL_HARDWARE += udfps
endif # TARGET_HAS_ADDITIONAL_HARDWARE += fingerprint
...
# GPS
ifneq ($(filter gnss,$(TARGET_HAS_ADDITIONAL_HARDWARE)),)
PRODUCT_PACKAGES += \
